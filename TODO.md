...
* 重寫成 Rust flight core
* 自己再包一套 FreeRTOS
* 把 repo 拆成多 repo
* 過早做 board/target 超抽象化
* 自創 MAVLink 等級大協定
...
1. models 分 dev/stable/experimental
2. freeze_model 工具
3. config validator
4. MadFlight adapter boundary
5. 文件化兩種通訊模式
...
如果你要，我還可以進一步看你 repo 的 `shared/` 該不該放協定 schema。
